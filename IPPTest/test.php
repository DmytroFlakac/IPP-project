...
foreach($argv as $arg)
{
    ...
    switch($split_arg[0])
    {
        case "--help":
			...
			echo "  --threads=<#Threads>   In default this program runs in one thread if you want faster testing use more threads negative numbers use (# of Tests / 100) threads\n";
            echo "\n";
            exit(0);
        case "--output":
...
if($thread_count < 1)
{
    $thread_count = ceil($test_count/100);
}

//split the work to threads
$work = array_chunk($results,$test_count/$thread_count);
